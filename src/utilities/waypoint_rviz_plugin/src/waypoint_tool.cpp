...
void WaypointTool::updateTopic()
{
  ...
  sub_ = raw_node->template create_subscription<nav_msgs::msg::Odometry>("/tita4264886/chassis/odometry", 5 ,std::bind(&WaypointTool::odomHandler,this,std::placeholders::_1));
