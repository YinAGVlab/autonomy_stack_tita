...
void GoalpointTool::updateTopic()
{
  ...
  sub_ = raw_node->template create_subscription<nav_msgs::msg::Odometry>("/tita4264886/chassis/odometry", 5 ,std::bind(&GoalpointTool::odomHandler,this,std::placeholders::_1));
  
  pub_ = raw_node->template create_publisher<geometry_msgs::msg::PointStamped>("/goal_point", qos_profile_);
  pub_joy_ = raw_node->template create_publisher<sensor_msgs::msg::Joy>("/tita4264886/joy", qos_profile_);
